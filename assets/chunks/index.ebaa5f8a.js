import{w as xt,a3 as Vn,a4 as Wn}from"./framework.f5583048.js";/*!
 * vuex v4.0.2
 * (c) 2021 Evan You
 * @license MIT
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=5*60,Bo=Qt("authIdTokenMaxAge")||xo;let Lt=null;const Fo=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Bo)return;const i=t==null?void 0:t.token;Lt!==i&&(Lt=i,await fetch(n,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function $o(n=Ri()){const e=nn(n,"auth");if(e.isInitialized())return e.getImmediate();const t=ms(n,{popupRedirectResolver:No,persistence:[Vs,Ps,Nn]}),r=Qt("authTokenSyncURL");if(r){const s=Fo(r);Cs(t,s,()=>s(t.currentUser)),Ss(t,o=>s(o))}const i=mr("auth");return i&&vs(t,`http://${i}`),t}Uo("Browser");const Ho={apiKey:"AIzaSyC1WfyhIqmL1n7ahPL-XVSAmBECWxMTUrg",authDomain:"gh-education.firebaseapp.com",projectId:"gh-education",storageBucket:"gh-education.appspot.com",messagingSenderId:"232266340667",appId:"1:232266340667:web:15dc478ab3ef65c66c7f1e",measurementId:"G-1N1LRJY9RP"};rn(Ho);const Ut=$o(),Wo=cr({state:{user:null,token:null,role:null},mutations:{setUser(n,e){n.user=e},setToken(n,e){n.token=e},setRole(n,e){n.role=e}},actions:{async login(n,{organization:e}){const t=new I;t.addScope("repo"),t.setCustomParameters({allow_signup:"false"});const r=await qs(Ut,t);if(r){const s=I.credentialFromResult(r).accessToken,o="https://api.github.com/user/memberships/orgs/"+e,l=(await(await fetch(o,{method:"GET",headers:{"X-GitHub-Api-Version":"2022-11-28",Authorization:`token ${s}`}})).json()).role=="admin"?"teacher":"member";n.commit("setUser",r.user),n.commit("setToken",s),n.commit("setRole",l)}else throw new Error("login failed")},async logout(n){await Rs(Ut),sessionStorage.clear(),n.commit("setUser",null),n.commit("setToken",null),n.commit("setRole",null)}},getters:{userData(n){return{user:n.user,token:n.token,role:n.role}}}});export{Vo as g,Wo as s};
