...
::: warning ¡Importante!
No vimos el lunes pasado el tema de los [Front Matter Defaults](https://jekyllrb.com/docs/configuration/front-matter-defaults/), en el `_config.yml`, **estudie y practique como se usan**. Muestre que los ha usado  en su informe de entrega.
